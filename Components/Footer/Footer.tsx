    ...
    <footer className="pt-15 pb-5">
      <Container className="flex justify-around">
        ...
        <div className="w-3/12 space-y-3">
          ...
          <p className="max-w-xs text-sm text-gray-400 cursor-default">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex gap-4">
            {socialLinks.map(({ link, icon, name }) => (
              ...
              >
                <span className="text-lg text-white transition-transform group-hover:scale-110">
                  {icon}
                </span>
              </a>
            ))}
