        ...
        <div className="w-full md:w-1/2 md:pl-6 md:border-l border-white/20 space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-white/90">
              ...
              <b>React.js</b>.
              <br />
              I have worked on WordPress in past companies but now I’m focusing
              on React development to build modern and interactive web apps.
              Currently expanding my skills beyond React by learning Next.js and
              backend development, aiming to become a full-stack JavaScript
              developer.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-white/90">
              ...
              Vite and TailwindCSS. I enjoy turning designs into fully functional
              interfaces and bringing ideas to life on the web.
            </p>
          </div>
